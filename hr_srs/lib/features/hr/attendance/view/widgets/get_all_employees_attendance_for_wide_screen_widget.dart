...
class GetAllEmployeesAttendanceForWideScreenWidget extends StatelessWidget {
  const GetAllEmployeesAttendanceForWideScreenWidget({
    super.key,
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ExpansionTile(
              ...
              subtitle: Text(
                "${S.of(context).department}: ${emp.department}",
                style: TextStyle(
